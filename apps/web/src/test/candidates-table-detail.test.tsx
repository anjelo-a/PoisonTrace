...
vi.stubGlobal("fetch", vi.fn(async (url: string) => {
  ...
  return new Response(JSON.stringify({ metrics: { candidatesEmitted: 1, unknownGateBlocks: 0, transactionsScanned: 10, passedTransactions: 8, lastScanUpdateAt: "2026-05-02T10:00:00Z", scanWindowLabel: "24h", passRatePct: 80 }, recentCandidates: [] }), { status: 200 });
